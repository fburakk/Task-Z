...
export class WorkspaceService {
  ...
  getWorkspace(id: number): Observable<Workspace> {
    ...
    return this.http.get<Workspace>(`${this.apiUrl}/${id}`, this.authService.getAuthHeaders());
  }

  // Update Workspace
  updateWorkspace(id: number, name: string): Observable<void> {
    console.log("updateworkspace");
    return this.http.put<void>(`${this.apiUrl}/${id}`, { name }, this.authService.getAuthHeaders());
  }
